...
disp_setting+="scrollbars=yes,width=1200, height=700, left=100, top=25";
   ...
   docprint.document.write('"http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">');
   docprint.document.write('<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">');
   docprint.document.write('<head><title>Result Examanation</title>');
   docprint.document.write('<style type="text/css">h5{padding-left: 3px; text-align:center;} h4{padding-left: 3px; text-align:center;}body{ margin:0px;');
