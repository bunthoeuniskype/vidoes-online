...
<div class="container-fluid"> 
        ...
        <h5 class="subcategory"><span class="mbr-iconfont mbri-video-play"></span> <a href="{{url('videofree')}}">{{ trans('common.video_free') }}</a></h5>  
    ...
    @foreach($posts->chunk(3) as $post)
      ...
      @endforeach
          ...
          <a class="btn btn-sm btn-secondary-outline display-3" href="{{url('videofreemore')}}">View All</a>
          </div>          
    </div>
