...
<div class="container-fluid">       
        ...
        <h5 class="subcategory">{{$subcategory->name}}</h5>
...
@if(count($posts) > 0)
        <div class="mbr-section-btn text-center">
          <a class="btn btn-sm btn-secondary-outline display-3" href="{{ url('subcategoryvideomore/'.$subcategory->slug) }}">All Videos</a>
          </div>
@else
<div class="mbr-section-btn text-center">
