          ...
          <tr>
            <td>{{ $i++ }}</td>                   
              <td>{{ $value->title }}</td>
               ...
               <a href="{{ url('admin/videolist/'.$value->group_id.'/delete') }}" class="btn btn-xs btn-danger"><i class="glyphicon glyphicon-remove"></i> {{ trans('common.delete') }}</a>
               </td>
...
<div class="panel panel-defualt" style="margin-top:-20px;">
                        ...
                        <h3 style="margin-top: 5px;"> {{ trans('common.add') }} {{ trans('common.videolist') }} </h3>
                         </div>
                            <div class="panel panel-body">
...
@include('errors/errors')
 ...
 {!! Form::open(array('url'=>'admin/videolist','id'=>'videolist','dojoType'=>'dijit/form/Form')) !!}
...
<script type="dojo/method" event="onSubmit">    
 ...
 <tr>
  ...
  <tr>
    <td>
          <label for="title">{{ trans('common.title') }} {{$v->name}}</label>
        </td>
        <td>
  {!! Form::text('title[]',null,array("data-dojo-type"=>"dijit/form/ValidationTextBox","id"=>"title_".$v->code, "required"=>"true" )) !!}
  </td>
  </tr>
@endforeach
<tr>
    <td>
        ...
        <td>
  {!! Form::text('video_id',null,array("data-dojo-type"=>"dijit/form/ValidationTextBox","id"=>"video_id_".$v->code, "required"=>"true" )) !!}
  </td>
  </tr>
