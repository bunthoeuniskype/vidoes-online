        ...
        @foreach($category as $value)
          <tr>
            <td>{{ $i++ }}</td>           
              <td>{{ $value->name }}</td>
               <td>{{ $value->order }}</td>
               <td><a href="{{ url('admin/category/'.$value->group_id.'/edit') }}" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-edit"></i> {{ trans('common.edit') }}</a>
               <a href="{{ url('admin/category/'.$value->group_id.'/delete') }}" class="btn btn-xs btn-danger"><i class="glyphicon glyphicon-remove"></i> {{ trans('common.delete') }}</a>
               </td>
